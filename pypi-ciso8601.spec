...
Source0  : https://files.pythonhosted.org/packages/09/e9/d83711081c997540aee59ad2f49d81f01d33e8551d766b0ebde346f605af/ciso8601-2.3.2.tar.gz
...
%prep
%setup -q -n ciso8601-2.3.2
cd %{_builddir}/ciso8601-2.3.2
pushd ..
cp -a ciso8601-2.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733821301
